...
ALARM_PATH := vendor/validus/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/validus/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/validus/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/validus/prebuilt/common/media/audio/ui
